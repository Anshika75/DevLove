          ...
          <div className='flex flex-col justify-center items-center rounded-md'>
            ...
            {relationshipStatus === 'single' && (
              <div className='w-full mb-4'>
                ...
                <div className='flex space-x-4'>
                  <button className={`bg-[#A2171C] border-none text-xl outline-none shadow-lg hover:scale-105 transition-all rounded-sm mt-4 px-3 py-2 ${protagonistGender === 'female' ? 'bg-[#A2171C]' : 'bg-[#444]'} ${protagonistGender === 'female' ? 'cursor-pointer' : 'cursor-not-allowed'}`} onClick={() => handleProtagonistGender('male')}>Male</button>
                  <button className={`bg-[#A2171C] border-none text-xl outline-none shadow-lg hover:scale-105 transition-all rounded-sm mt-4 px-3 py-2 ${protagonistGender === 'male' ? 'bg-[#A2171C]' : 'bg-[#444]'} ${protagonistGender === 'male' ? 'cursor-pointer' : 'cursor-not-allowed'}`} onClick={() => handleProtagonistGender('female')}>Female</button>
                </div>
              </div>
            )}
